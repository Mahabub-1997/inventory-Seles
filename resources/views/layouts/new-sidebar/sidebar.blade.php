...
{{--            <h3 class="text-primary" style="font-weight: bold">Chokrojan</h3>--}}
            <img class="app-logo me-2" width="100" src="{{asset($setting->logo)}}" style="width: 180px" alt="">
        </div>
        <button
                        ...
                        <ul class="list-group">
                            ...
                            @can('products_view')
                                <li>
                                    @include('components.sidebar.child-navitem', [
                                        'href'=>'/products/products',
                                        'title'=> __('translate.CurrentStock')
                                    ])
                                </li>
                            @endcan
                            @can('products_add')
